...
const clubs = [
  {
    ...
    amenities: ['Premium Interior Lounge', 'Private Lounge Areas', 'Indoor-Only Club', 'Remote Work & Creative Zone', 'Member Events', 'Member-Only Discounts & Prizes', 'Vegan Menu Options', 'Munchies & Drinks'],
    vibeTags: ['Community-Focused', 'Premium Interior', 'Tourist-Friendly', 'Social & Chill'],
    priceRange: '$$',
    capacity: 10000,
    foundedYear: 2018,
    images: [
