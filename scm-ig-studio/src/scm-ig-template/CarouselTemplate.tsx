      ...
      <SlideContainer bgClass={base}>
        ...
        <div className={`flex flex-col h-full ${white} relative z-10 p-[70px] justify-between`}>
          <div className="w-full flex justify-between items-start border-b-[1px] border-brand-divider/80 pb-6">
             <span className="font-mono font-bold text-[18px] uppercase tracking-[0.3em] text-brand-teal mt-2">
               RESOURCE // KIT
             </span>
          ...
          <div className="flex flex-col items-end pt-12 border-t-[1px] border-brand-divider/80">
             <div className="w-full flex flex-col items-end gap-4">
                <div className="flex items-center gap-6">
                  <span className="font-mono font-bold text-[42px] tracking-[0.18em] text-brand-main uppercase text-right">
                    DOWNLOAD THE SAFETY KIT
                  </span>
                  <span className="font-serif italic text-[60px] leading-none text-brand-saffron shrink-0">
                    &rarr;
                  </span>
                </div>
                <p className="font-mono text-[24px] uppercase tracking-[0.35em] text-brand-muted text-right">
                  LINK IN BIO.
                </p>
                <p className="font-mono text-[18px] tracking-[0.18em] text-brand-teal text-right">
                  socialclubsmaps.com/safety-kit
                </p>
             </div>
          </div>
        </div>
