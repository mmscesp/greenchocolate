...
function buildDisplayNames(locale: Locale) {
  try {
...
export function getCountryOptions(locale: Locale): CountryOption[] {
  ...
  return [...COUNTRY_CODES]
    .map((code) => ({
      code,
      label: displayNames?.of(code) || FALLBACK_COUNTRY_LABELS[code] || code,
    }))
    .sort((left, right) => left.label.localeCompare(right.label, locale));
}

export function getCountryLabel(locale: Locale, code: string): string {
