    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-emerald-50 pt-24 md:pt-32 pb-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        {userProfile.role === 'CLUB_ADMIN' && (
          <div className="mt-12">
            <h2 className="text-2xl font-bold mb-6">{t('account.operator_support.title')}</h2>
            <Card className="bg-gradient-to-r from-green-50 to-emerald-50 border-green-200">
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  <Shield className="h-5 w-5 text-green-600" />
                  {t('account.operator_support.title')}
                </CardTitle>
                <CardDescription>
                  {t('account.operator_support.description')}
                </CardDescription>
              </CardHeader>
              <CardContent>
                <Link href={`/${lang}/contact`}>
                  <Button className="bg-green-600 hover:bg-green-700 text-white">
                    {t('account.operator_support.cta')}
