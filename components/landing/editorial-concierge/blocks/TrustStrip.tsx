...
export function TrustStrip() {
  return (
    ...
    <div className="sticky top-16 z-40 w-full h-12 bg-black/90 backdrop-blur-xl border-b border-white/10 flex items-center shadow-lg transition-all duration-300">
      <div className="max-w-7xl mx-auto px-6 w-full flex items-center justify-between">
        
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-2">
            <PulsingStatusDot />
            <ConciergeLabel size="xs" emphasis="high" className="text-white">Status: Verified</ConciergeLabel>
          </div>
