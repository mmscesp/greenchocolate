...
import { MapPin, Star, Users, Clock, CheckCircle, Sparkles } from 'lucide-react';
      ...
      <div className="p-6">
        ...
        <div className="flex items-center justify-between text-sm text-muted-foreground mb-6 bg-muted/50 rounded-lg p-3">
          <div className="flex items-center gap-2">
            ...
            <span className="font-medium">{club.capacity} {t('club.people')}</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="p-1 bg-primary/10 rounded-full">
              <Clock className="h-3 w-3 text-primary" />
            </div>
            <span className="font-medium">{t('club.founded')} {club.foundedYear}</span>
          </div>
        </div>
