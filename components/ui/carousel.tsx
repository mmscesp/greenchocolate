...
type CarouselProps = {
  ...
  labels?: {
    regionRoleDescription?: string;
    slideRoleDescription?: string;
    previousSlideSr?: string;
    nextSlideSr?: string;
  };
};
    ...
    return (
      ...
      >
        <div
          ...
          role="region"
          aria-roledescription={labels?.regionRoleDescription || 'carousel'}
          {...props}
        >
          {children}
        </div>
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      role="group"
      aria-roledescription={labels?.slideRoleDescription || 'slide'}
      className={cn(
