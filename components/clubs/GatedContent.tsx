    ...
    <div className="relative overflow-hidden rounded-[2rem] group border border-white/5 bg-bg-base">
      ...
      <div className={`${blurClass} select-none pointer-events-none opacity-10 p-8`}>
        <div className="space-y-4">
           <div className="h-6 w-3/4 bg-brand/10 rounded-lg"></div>
           <div className="h-4 w-1/2 bg-brand/10 rounded-lg"></div>
           <div className="h-4 w-full bg-brand/10 rounded-lg"></div>
           <div className="h-4 w-5/6 bg-brand/10 rounded-lg"></div>
           <div className="h-10 w-full bg-brand/10 rounded-xl mt-6"></div>
        </div>
      </div>
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/40 backdrop-blur-[2px] z-10 p-6 text-center">
         <div className="bg-bg-base/95 backdrop-blur-md p-8 sm:p-10 rounded-[2.5rem] border border-white/10 shadow-2xl max-w-md w-full relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="mx-auto w-16 h-16 bg-brand/10 rounded-2xl flex items-center justify-center mb-6 border border-brand/20">
              ...
              <div className="grid gap-4">
                ...
                <div className="flex items-center justify-center gap-4 mt-2">
                  <Link href={withLocale('/account/login')} className="text-[10px] font-bold text-zinc-500 hover:text-brand uppercase tracking-widest transition-colors">
                    {t('clubs.gated.member_login')}
                  </Link>
                  <div className="w-1 h-1 bg-white/10 rounded-full" />
                  <Link href={withLocale('/editorial/legal')} className="text-[10px] font-bold text-zinc-500 hover:text-brand uppercase tracking-widest transition-colors">
